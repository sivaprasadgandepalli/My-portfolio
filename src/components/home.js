                    ...
                    <div className='col-md-8'>
                        <div className='px-2'>
                            ...
                            <Text fontSize='16px' color='lightGrey'>
                               I've dedicated the past year to my role as a web developer, specializing in Web Technologies. I possess proficiency in various technologies 
                                within the web ecosystem, including JavaScript, React, Node.js, MongoDB, MySQL, and numerous others.
                            </Text>
